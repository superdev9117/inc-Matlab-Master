app.controller('codeCtrlC5S5', function($scope, $http) {

    $scope.q1hints;

    $scope.q1 = "1. What is b as a result of the following commands?" +
        "<br> <code>>> A = [1 2; 3 4; 5 6] <br> >> b = A(2,3) </code>"
        /*<br> <code> </code>*/


    $scope.q2 = "2. What is B as a result of the following commands?" +
        "<br> <code>>> A = [1 2 3; 4 5 6; 7 8 9] <br> >> B = A(2:3,1:2) </code>"

    $scope.q3 = "3. What is B as a result of the following commands?" +
        "<br> <code>>> A = [1 2 3; 4 5 6; 7 8 9] <br>  >> B = A(:,1:2)</code>"


    $scope.q1options = [
        { text: "b = 6 ", hints: "names don’t matter, it’s the order in the list.", correct: true, type: "ms", chosen: 0 },
        { text: "b = [3 4]  ", hints: "function doesn’t affect value of var1 in the workspace", correct: true, type: "ms", chosen: 0 },
        { text: "b = 4 ", hints: "function doesn’t affect value of var1 in the workspace", correct: false, type: "ms", chosen: 0 },
        { text: "None of the above ", hints: "var1 is not defined in the workspace.", correct: false, type: "ms", chosen: 0 },

    ]

    $scope.q2options = [
        { text: "B = <br> 1 2 <br> 4 5 <br>", hints: "names don’t matter, it’s the order in the list.", correct: true, type: "ms", chosen: 0 },
        { text: "B = <br> 2 3 <br> 4 6 <br>", hints: "names don’t matter, it’s the order in the list.", correct: false, type: "ms", chosen: 0 },
        { text: "B = <br> 4 5 <br> 7 8 <br>", hints: "only the second element of x is sent to the function.", hints: "names don’t matter, it’s the order in the list.", correct: false, type: "ms", chosen: 0 },
    ...
    $scope.q3options = [
        { text: "B = <br> 1 2 <br> 4 5 <br> 7 8 <br>", hints: "names don’t matter, it’s the order in the list", correct: true, type: "ms", chosen: 0 },
        { text: "B = <br> 1 <br> 4 <br> 7 <br>", hints: "names don’t matter, it’s the order in the list.", correct: true, type: "ms", chosen: 0 },
        { text: "B = <br> 1 2 3<br> 4 5 6<br> ", hints: "only the second element of x is sent to the function.", hints: "names don’t matter, it’s the order in the list.", correct: false, type: "ms", chosen: 0 },
